...
## Algorithm
1. Import the required libraries and create the dataset containing spam and ham messages.
2. Convert the text messages into numerical features using TF-IDF vectorization.
3. Split the dataset into training and testing data and train the SVM classifier.
4. Predict whether the message is spam or ham and evaluate the model performance.
...
## Output:
<img width="384" height="226" alt="image" src="https://github.com/user-attachments/assets/6ca02878-e9c6-4d56-97fe-6239da5d73eb" />
